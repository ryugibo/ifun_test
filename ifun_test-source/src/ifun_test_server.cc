...
class IfunTestServer : public Component {
 public:
  static bool Install(const ArgumentMap &arguments) {
    ...
    LOG(INFO) << "example_arg2: " << arg2;
     ...
     // You can override gflag like this: ./ifun_test-local --example_arg3=hahaha
...
REGISTER_STARTABLE_COMPONENT(IfunTestServer, IfunTestServer)
